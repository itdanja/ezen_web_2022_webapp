	...
	public static void main(String[] args) {
		...
		*/
			...
			while( rs.next() ) { // while (조건) : 조건이 true 이면 반복문 실행 
				// rs.next() : 다음 레코드 이동 
				System.out.print("회원아이디 : " +rs.getString(1) +"\t"); // 첫번째 필드의 데이터 가져오기 [ member_id ]
				System.out.print("회원명 : " +rs.getString(2) +"\t" );	// 두번째 필드의 데이터 가져오기 [ member_name ]
				System.out.print("회원주소 : " +rs.getString(3) +"\n" );	// 세번재 필드의 데이터 가져오기 [ member_addr ]
			} 
